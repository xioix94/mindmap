...
import {
  createStore,
  useStore
} from "./chunk-JEIAUOUA.js";
import {
  require_react
} from "./chunk-UWDTMQLH.js";
import {
  shallow
} from "./chunk-7ACP6PRO.js";
import {
  __toESM
...
var StepEdge = (0, import_react.memo)((props) => {
  var _a;
  return (0, import_jsx_runtime.jsx)(SmoothStepEdge, { ...props, pathOptions: (0, import_react.useMemo)(() => {
    var _a2;
...
var Handle = (0, import_react.forwardRef)(({ type = "source", position = Position.Top, isValidConnection = alwaysValid, isConnectable = true, id: id2, onConnect, children: children2, className, onMouseDown, ...rest }, ref) => {
    ...
    if (d3Selection && d3Zoom) {
      return {
        ...
        fitBounds: (bounds, options) => {
          ...
          const [x, y, zoom] = getTransformForBounds(bounds, width, height, minZoom, maxZoom, (options == null ? void 0 : options.padding) ?? 0.1);
...
function useReactFlow() {
  ...
  const getNode = (0, import_react.useCallback)((id2) => {
  ...
  const getEdge = (0, import_react.useCallback)((id2) => {
    const { edges = [] } = store.getState();
...
var ZoomPane = ({ onMove, onMoveStart, onMoveEnd, onPaneContextMenu, zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = 0.5, panOnScrollMode = PanOnScrollMode.Free, zoomOnDoubleClick = true, elementsSelectable, panOnDrag = true, defaultViewport, translateExtent, minZoom, maxZoom, zoomActivationKeyCode, preventScrolling = true, children: children2, noWheelClassName, noPanClassName }) => {
  ...
  const { d3Zoom, d3Selection, d3ZoomHandler, userSelectionActive } = useStore2(selector$9, shallow);
...
function UserSelection() {
  const { userSelectionActive, userSelectionRect } = useStore2(selector$8, shallow);
...
var Pane = (0, import_react.memo)(({ isSelecting, selectionMode = SelectionMode.Full, panOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children: children2 }) => {
  ...
  const { userSelectionActive, elementsSelectable, dragging } = useStore2(selector$7, shallow);
...
function NodesSelection({ onSelectionContextMenu, noPanClassName, disableKeyboardA11y }) {
  const store = useStoreApi();
  const { transformString, userSelectionActive } = useStore2(selector$6, shallow);
...
function useVisibleNodes(onlyRenderVisible) {
  const nodes = useStore2((0, import_react.useCallback)((s) => onlyRenderVisible ? getNodesInside(s.nodeInternals, { x: 0, y: 0, width: s.width, height: s.height }, s.transform, true) : s.getNodes(), [onlyRenderVisible]));
  return nodes;
}
var selector$4 = (s) => ({
...
function useVisibleEdges(onlyRenderVisible, nodeInternals, elevateEdgesOnSelect) {
  const edges = useStore2((0, import_react.useCallback)((s) => {
...
var ConnectionLine = ({ connectionNodeId, connectionHandleType, connectionLineStyle, connectionLineType = ConnectionLineType.Bezier, isConnectable, CustomConnectionLineComponent }) => {
  var _a, _b, _c;
  const { fromNode, handleId, toX, toY, connectionMode } = useStore2((0, import_react.useCallback)((s) => ({
  ...
  const fromHandleX = fromHandle ? fromHandle.x + fromHandle.width / 2 : ((fromNode == null ? void 0 : fromNode.width) ?? 0) / 2;
  const fromHandleY = fromHandle ? fromHandle.y + fromHandle.height / 2 : (fromNode == null ? void 0 : fromNode.height) ?? 0;
  const fromX = (((_b = fromNode == null ? void 0 : fromNode.positionAbsolute) == null ? void 0 : _b.x) || 0) + fromHandleX;
  const fromY = (((_c = fromNode == null ? void 0 : fromNode.positionAbsolute) == null ? void 0 : _c.y) || 0) + fromHandleY;
...
function useUpdateNodeInternals() {
  const store = useStoreApi();
  return (0, import_react.useCallback)((id2) => {
...
function MiniMap({ style: style2, className, nodeStrokeColor = "transparent", nodeColor = "#e2e2e2", nodeClassName = "", nodeBorderRadius = 5, nodeStrokeWidth = 2, maskColor = "rgb(240, 240, 240, 0.6)", maskStrokeColor = "none", maskStrokeWidth = 1, position = "bottom-right", onClick, onNodeClick, pannable = false, zoomable = false, ariaLabel = "React Flow mini map" }) {
  ...
  return (0, import_jsx_runtime2.jsx)(Panel, { position, style: style2, className: cc(["react-flow__minimap", className]), children: (0, import_jsx_runtime2.jsxs)("svg", { width: elementWidth, height: elementHeight, viewBox: `${x} ${y} ${width} ${height}`, role: "img", "aria-labelledby": labelledBy, ref: svg, onClick: onSvgClick, children: [ariaLabel && (0, import_jsx_runtime2.jsx)("title", { id: labelledBy, children: ariaLabel }), nodes.map((node) => {
    ...
    return (0, import_jsx_runtime2.jsx)(MiniMapNode$1, { x: x2, y: y2, width: node.width, height: node.height, style: node.style, className: nodeClassNameFunc(node), color: nodeColorFunc(node), borderRadius: nodeBorderRadius, strokeColor: nodeStrokeColorFunc(node), strokeWidth: nodeStrokeWidth, shapeRendering, onClick: onSvgNodeClick, id: node.id }, node.id);
...
function NodeToolbar({ nodeId, children: children2, className, style: style2, isVisible, position = Position.Top, offset = 10, ...rest }) {
  ...
  const nodes = useStore2(nodesSelector2, nodesEqualityFn);
